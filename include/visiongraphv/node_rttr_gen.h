...
#define PARM_FILEPATH visiongraph/comp/##PARM_NODE_CLASS##.parm.h
#endif

#define RTTR_NAME vgv::##PARM_NODE_NAME

rttr::registration::class_<vgv::node::PARM_NODE_CLASS>(XSTR(RTTR_NAME))
.constructor<>()

#define PARAM_INFO(id, type, name, member, default_val)        \
.property(#name, &vgv::node::##PARM_NODE_CLASS::member)        \
(                                                              \
